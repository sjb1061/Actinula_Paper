...
```{r parseOF}
# Part 1: parse OrthoFinder format to annotate with Human Gene Symbols
...
### Part 2 GeneGlobe apoptosis gene-set, blasted for *Homo* hits
...
nrow(actinula_acc_apo_OGs_acc_sym) 

#Get original header for heatmap/salmon 
...
unique(actinula_acc_apo_OGs_acc_sym$OG)
unique(actinula_acc_apo_OGs_acc_sym$Actinula_seqid)
nrow(actinula_acc_apo_OGs_acc_sym) 
