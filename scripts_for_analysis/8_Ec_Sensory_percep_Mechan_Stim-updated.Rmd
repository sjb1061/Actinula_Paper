...
refblast<-read.table("Homo.fa_ref_blastout_percep_mechan_stim ",header=F,stringsAsFactors = F)
head(refblast) 
names(refblast)[1:2]<-c("gene_acc","seqid")

#link gene_acc to gene symbol (human)
homo_symbols<-read.table("gene_symbol_accid_percep_mechan_stim",header=F,stringsAsFactors = F) 
...
write.table(actinula_acc_apo_OGs_acc_sym, "C:\\Desktop\\R\\Transcriptomics_Actinula_3-17-20\\Reduced_Ec_Sensory_Percep_Mechan_Stim_R_output_genes.txt", sep="\t")
