...
homohydra.map<- read.table("Reduced_Ec_Sensory_Percep_Chem_Stim_R_output_genes.txt",header=T, stringsAsFactors=F) #Reduced
...
all_symbols_for_OGs <- read.delim("~/Desktop/R /Transcriptomics_Actinula_3-17-20/DEGs_p0.05_6groups/Reduced R output genes from geneset and symbols/sens_percep_chem_stim-all_symbols_for_OGs.txt") #Reduced
...
#REDUCED
sig_degs<-c("Ec_actinula_t.55411","Ec_actinula_t.81080","Ec_actinula_t.98433","Ec_actinula_t.81080","Ec_actinula_t.66208","Ec_actinula_t.68440","Ec_actinula_t.81080","Ec_actinula_t.66208","Ec_actinula_t.98433","Ec_actinula_t.81080"
) #Reduced 
...
#import collapsed symbols for OG - add to dataset
all_symbols_for_OGs <- read.delim("~/Desktop/R /Transcriptomics_Actinula_3-17-20/DEGs_p0.05_6groups/Reduced R output genes from geneset and symbols/sens_percep_chem_stim-all_symbols_for_OGs.txt")
names(all_symbols_for_OGs)[2] <- c("tot_symbol")
str(all_symbols_for_OGs)
all_symbols_for_OGs$OG<- as.character(all_symbols_for_OGs$OG)
all_symbols_for_OGs$tot_symbol<- as.character(all_symbols_for_OGs$tot_symbol)
