 ...
 * Examines DEGs at p-value = 0.05 
  ...
  What you need to change in this script (in order):   
  * Set your working directory
  * Adjust the number of stages accordingly for reading in the data, here we have 6 stages 
