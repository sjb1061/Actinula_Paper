...
#name of script: find_upregulated_stg_5_genes.py
#created: 9/3/20

#Purpose: This script will go through each edgeR comparison file and will add headers of positive  
#logFC to a dictionary and will write that out to a new file --> positive = up-regulated in stg 5 
...
with open("stg_5_upregulated_headers.txt", "w") as out_handle: 
    for key in tot_db: 
        out_handle.write(key+"\n")
print("Your file has been created! File Name: stg_5_upregulated_headers.txt")
